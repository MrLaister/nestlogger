...
import time
import json
import urllib3 # Updated from urllib2
import sched

sys.path.append("/home/pi/git/nestlogger_config")

from configmrl import *
...
#meteo=urllib3.urlopen(url).read()	#updated to urllib3 from urllib2
...
#req = urllib3.Request('https://maker.ifttt.com/trigger/logtemperature/with/key/kbbmhSZNpxGDaf4wo-ZXn3qGr9kZdNZUqKkl-RqRwWW') # Replace XXX with your IFTTT Maker Key. 
